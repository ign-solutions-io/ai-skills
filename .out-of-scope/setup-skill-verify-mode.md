# Verify/Check Mode for `setup-ai-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-ai-skills`.
...
- #106 — Feature request: verify/check mode for setup-ai-skills
