...
A collection of agent skills (slash commands and behaviors) for Claude Code and Cursor. Skills are organized into buckets and consumed by per-repo configuration emitted by `/setup-ai-skills`.
