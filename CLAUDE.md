...
- **Install locally**: `scripts/link-skills.sh <claude|cursor>` symlinks the live buckets into `~/.claude/skills` or `~/.cursor/skills`. Re-run after adding, renaming, or retagging a skill.
